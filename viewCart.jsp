...
<div ng-app="myApp" ng-controller="customersCtrl">
 ...
 <a href="hello" class="btn btn-success pull-right"><span class="glyphicon glyphicon-shopping-cart"></span> Check out</a>
...
<table class="table table-hover table-bordered">
 ...
 <a href="${pageContext.servletContext.contextPath}/ret" class="btn btn-success pull-right">Continue Shopping</a>
